...
<div>
    <form method="get" action="#">
        <table class="tab" width="100%">
            <tr>
                <td style="background-color: gainsboro;" colspan="11"><span id="touspan">未归还的图书记录</span></td>
            </tr>
            <tr>
                <td colspan="11">
            ...
            <c:forEach var="tbrecord" items="${tbRecordsList}" varStatus="status">
                <tr style="text-align: center" id="menu2">
                    ...
                    <td>
                            <span id="return">
                                <a class="TbRecordmodif" href="javascript:;"id=${tbrecord.id}><c:if test="${tbrecord.returnBook==0}">-未归还</c:if></a>
                            </span>
                    </td>
                </tr>
            </c:forEach>
